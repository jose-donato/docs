...
```python
openbb.crypto.load(symbol: str, start_date: datetime.datetime | str | None = None, interval: str = "1440", exchange: str = "binance", vs_currency: str = "usdt", end_date: datetime.datetime | str | None = None, source: str = "CCXT")
```
