...
```python
openbb.crypto.ov.cpmarkets(symbols: str = "USD", sortby: str = "rank", ascend: bool = True)
```
...
```python
openbb.crypto.ov.cpmarkets_chart(symbol: str, sortby: str = "rank", ascend: bool = True, limit: int = 15, export: str = "")
```
