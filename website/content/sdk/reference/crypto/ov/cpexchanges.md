...
```python
openbb.crypto.ov.cpexchanges(symbols: str = "USD", sortby: str = "rank", ascend: bool = True)
```
...
```python
openbb.crypto.ov.cpexchanges_chart(symbol: str, sortby: str = "rank", ascend: bool = True, limit: int = 15, export: str = "")
```
