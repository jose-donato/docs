...
```python
openbb.crypto.ov.exchanges(sortby: str = "Rank", ascend: bool = True)
```
...
```python
openbb.crypto.ov.exchanges_chart(sortby: str = "Rank", ascend: bool = False, limit: int = 15, links: bool = False, export: str = "")
```
