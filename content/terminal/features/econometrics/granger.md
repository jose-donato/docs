...
| ---- | ----------- | ------- | -------- | ------- |
| ts | Requires two time series, the first time series is assumed to be Granger-caused by the second time series. | None | False |  |
| lags | How many lags should be included | 3 | False | None |
| confidence | Set the confidence level | 0.05 | False | None |
