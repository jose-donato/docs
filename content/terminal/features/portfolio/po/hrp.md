...
| ==SUPPRESS== | sensitivity analysis | None | False | sa:  ArgumentParser(prog='hrp sa', usage=None, description=None, formatter_class=<class 'argparse.HelpFormatter'>, conflict_handler='error', add_help=True) |
...
| name | Save portfolio with personalized or default name | _HRP0 | False | None |
