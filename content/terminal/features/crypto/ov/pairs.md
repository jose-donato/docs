...
| ---- | ----------- | ------- | -------- | ------- |
| limit | display N number of pairs =10 | 15 | False | None |
| sortby | Sort by given column. Default: id | id | False | id, display_name, base_currency, quote_currency, base_min_size, base_max_size, min_market_funds, max_market_funds |
