...
## openbb_terminal.forecast.nhits_model.get_nhits_data
...
| force_reset | bool | If set to True, any previously-existing model with the same name will be reset (all checkpoints will be<br/>discarded). Defaults to True. | True | False |
...
## openbb_terminal.forecast.nhits_view.display_nhits_forecast
