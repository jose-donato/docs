...
## openbb_terminal.forecast.expo_model.get_expo_data

```python title='openbb_terminal/forecast/expo_model.py'
def get_expo_data(data: Union[pd.Series, pd.DataFrame], target_column: str, trend: str, seasonal: str, seasonal_periods: int, dampen: str, n_predict: int, start_window: float, forecast_horizon: int) -> Tuple
```
[Source Code](https://github.com/OpenBB-finance/OpenBBTerminal/tree/main/openbb_terminal/forecast/expo_model.py#L34)
...
| trend | str | Trend component.  One of [N, A, M]<br/>Defaults to ADDITIVE. | ADDITIVE | False |
| seasonal | str | Seasonal component.  One of [N, A, M]<br/>Defaults to ADDITIVE. | ADDITIVE | False |
...
## openbb_terminal.forecast.expo_view.display_expo_forecast
