...
## openbb_terminal.forecast.theta_model.get_theta_data

```python title='openbb_terminal/forecast/theta_model.py'
def get_theta_data(data: Union[pd.Series, pd.DataFrame], target_column: str, seasonal: str, seasonal_periods: int, n_predict: int, start_window: float, forecast_horizon: int) -> Tuple
```
...
## openbb_terminal.forecast.theta_view.display_theta_forecast
