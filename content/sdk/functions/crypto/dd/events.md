...
## openbb_terminal.cryptocurrency.due_diligence.coinpaprika_model.get_coin_events_by_id
...
```
[Source Code](https://github.com/OpenBB-finance/OpenBBTerminal/tree/main/openbb_terminal/cryptocurrency/due_diligence/coinpaprika_model.py#L91)
...
## openbb_terminal.cryptocurrency.due_diligence.coinpaprika_view.display_events
...
Description: Prints table showing all events for given coin id. [Source: CoinPaprika]
