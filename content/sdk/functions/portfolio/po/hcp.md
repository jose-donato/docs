...
## openbb_terminal.portfolio.portfolio_optimization.optimizer_model.get_hcp_portfolio
...
```
[Source Code](https://github.com/OpenBB-finance/OpenBBTerminal/tree/main/openbb_terminal/portfolio/portfolio_optimization/optimizer_model.py#L2016)
...
| risk_free_rate | float | Risk free rate, must be in annual frequency.<br/>Used for 'FLPM' and 'SLPM'. The default is 0. | 0 | True |
...
## openbb_terminal.portfolio.portfolio_optimization.optimizer_view.display_hcp
