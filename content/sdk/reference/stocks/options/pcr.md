...
```python
openbb.stocks.options.pcr_chart(symbol: str, window: int = 30, start_date: str = "2021-11-20", export: str = "", external_axes: Optional[List[matplotlib.axes._axes.Axes]] = None)
```
...
| start_date | str | Starting date for data, by default (datetime.now() - timedelta(days=366)).strftime("%Y-%m-%d") | 2021-11-20 | True |
